...
public class LinuxOperatingSystem extends AbstractOperatingSystem {
	...
	private static String filenameToFamily(String name) {
		if (name.toLowerCase().equals(""))
			return "Solaris";
		else if (name.toLowerCase().equals("blackcat"))
			return "Black Cat";
		else if (name.toLowerCase().equals("bluewhite64"))
			return "BlueWhite64";
		else if (name.toLowerCase().equals("e-smith"))
			return "SME Server";
		else if (name.toLowerCase().equals("eos"))
			return "FreeEOS";
		else if (name.toLowerCase().equals("hlfs"))
			return "HLFS";
		else if (name.toLowerCase().equals("lfs"))
			return "Linux-From-Scratch";
		else if (name.toLowerCase().equals("linuxppc"))
			return "Linux-PPC";
		else if (name.toLowerCase().equals("meego"))
			return "MeeGo";
		else if (name.toLowerCase().equals("mandakelinux"))
			return "Mandrake";
		else if (name.toLowerCase().equals("mklinux"))
			return "MkLinux";
		else if (name.toLowerCase().equals("nld"))
			return "Novell Linux Desktop";
		else if (name.toLowerCase().equals("novell"))
			return "novel";
		else if (name.toLowerCase().equals("SuSE"))
			return "SUSE Linux";
		else if (name.toLowerCase().equals("pld"))
			return "PLD";
		else if (name.toLowerCase().equals("redhat"))
			return "Red Hat Linux";
		else if (name.toLowerCase().equals("sles"))
			return "SUSE Linux ES9";
		else if (name.toLowerCase().equals("sun"))
			return "Sun JDS";
		else if (name.toLowerCase().equals("synoinfo"))
			return "Synology";
		else if (name.toLowerCase().equals("tinysofa"))
			return "Tiny Sofa";
		else if (name.toLowerCase().equals("turbolinux"))
			return "TurboLinux";
		else if (name.toLowerCase().equals("ultrapenguin"))
			return "UltraPenguin";
		else if (name.toLowerCase().equals("va"))
			return "VA-Linux";
		else if (name.toLowerCase().equals("vmware"))
			return "VMWareESX";
		else if (name.toLowerCase().equals("yellowdog"))
			return "Yellow Dog";

		// /etc/issue will end up here:
		else if (name.toLowerCase().equals("issue"))
			return "Unknown";
